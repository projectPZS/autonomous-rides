...
def book_from_chrancowki():
    ...
    booking_info['price'] = 5 if is_ride_of_the_day else 32
    dolina_koscielisk_section.destroy()
...
def book_from_maja():
    ...
    booking_info['price'] = 5 if is_ride_of_the_day else 38
    dolina_koscielisk_section.destroy()
    booking.finalize_ride_booking(booking_info)
...
def load_dolina_koscieliska():
    ...
    if (datetime.now().weekday() == 1):
        dolina_koscielisk_section.create_text(80, 0, anchor=NW, text="This is the ride of the day! Get it for 5zł", fill='#2596be',
                                       font=('Inter 12 bold'))
    ...
    dolina_koscielisk_section.create_text(75, 50, anchor=NW, text="Chrancówki 35 Station", fill='#36454F',
                                       font=('Inter 16 bold'))
    dolina_koscielisk_section.create_text(75, 100, anchor=NW, text="Distance of the course: 16km", fill='#36454F',
                                       font=('Inter 10 normal'))

    dolina_koscielisk_section.create_text(75, 170, anchor=NW, text="Departue at: 10:00", fill='#36454F',
                                       font=('Inter 12 normal'))
    dolina_koscielisk_section.create_text(275, 170, anchor=NW, text="Casual price: 32zł", fill='#36454F',
                                       font=('Inter 12 normal'))

    dolina_koscielisk_section.book_img = PhotoImage(file='assets/icons/basket.png')
    book_button1 = Button(dolina_koscielisk_section, image = dolina_koscielisk_section.book_img, relief=FLAT, activebackground='#ffffff', bd=0, background='#ffffff', cursor='hand2', command=book_from_chrancowki)
    book_button1.place(x=220, y=155)

    dolina_koscielisk_section.create_text(650, 50, anchor=NW, text="Al. 3 Maja Dolne Station",
                                       fill='#36454F',
                                       font=('Inter 16 bold'))
    dolina_koscielisk_section.create_text(650, 100, anchor=NW, text="Distance of the course: 19km", fill='#36454F',
                                       font=('Inter 10 normal'))
    dolina_koscielisk_section.create_text(650, 170, anchor=NW, text="Departue at: 17:00", fill='#36454F',
                                       font=('Inter 12 normal'))
    dolina_koscielisk_section.create_text(850, 170, anchor=NW, text="Casual price: 38zł", fill='#36454F',
                                       font=('Inter 12 normal'))
