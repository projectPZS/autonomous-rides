...
def create_dashboard_header():
    ...
    dashboard_header_container.create_text(910, 22, anchor=NW, text = login.user_first_name, fill='#101828', font=('Inter 15 bold'))
    dashboard_header_container.create_text(910, 52, anchor=NW, text = login.user_last_name, fill='#101828', font=('Inter 15 bold'))
...
def create_rides_history_card():
    ...
    rides_history_card_container.create_text(25, 25, anchor=NW, text ='Rides explorer', fill='#101828', font=('Inter 15 bold'))
    rides_history_card_container.create_text(25, 50, anchor=NW, text ='All your booked rides in one place', fill='#101828', font=('Inter 10'))
    ...
    rides_history_card_button = Button(text="Search for your ride", padx=15, font = ('Inter 12 bold'), background='white', fg='black', command=rides_history.load_rides_history, cursor='hand2')
...
def create_custom_ride_card():
    ...
    custom_ride_card_button = Button(text="View history", padx=15, font = ('Inter 12 bold'), background='white', fg='black', cursor='hand2')
    ...
    custom_ride_card_button = Button(text="Get your ride", padx=15, font = ('Inter 12 bold'), background='white', fg='black', command=custom_ride.load_custom_rides_section, cursor='hand2')
...
def create_touristic_routes_card():
    ...
    # Create the card button
    touristic_routes_card_button = Button(text="Choose a route", padx=15, font = ('Inter 12 bold'), background='white', fg='black', command=touristic_routes.load_touristic_routes, cursor='hand2')
