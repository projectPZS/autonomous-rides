...
def load_touristic_routes():
    ...
    touristic_routes_section.create_text(775, 95, text="Najbliższy odjazd o: "+current_time, font=('Inter 13 normal'), fill='#101828')
    ...
    touristic_routes_section.create_text(775, 170, text="Najbliższy odjazd o: "+current_time, font=('Inter 13 normal'), fill='#101828')
    ...
    touristic_routes_section.create_text(775, 245, text="Najbliższy odjazd o: "+current_time, font=('Inter 13 normal'), fill='#101828')
    ...
    touristic_routes_section.create_text(775, 320, text="Najbliższy odjazd o: "+current_time, font=('Inter 13 normal'), fill='#101828')
    ...
    touristic_routes_section.create_text(775, 395, text="Najbliższy odjazd o: "+current_time, font=('Inter 13 normal'), fill='#101828')
    ...
    touristic_routes_section.create_text(775, 470, text="Najbliższy odjazd o: "+current_time, font=('Inter 13 normal'), fill='#101828')
    ...
    touristic_routes_section.create_text(775, 545, text="Najbliższy odjazd o: " + current_time,
                                         font=('Inter 13 normal'), fill='#101828')
