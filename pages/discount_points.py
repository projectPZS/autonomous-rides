...
def load_discount_points_section():
    ...
    discount_points_section.create_text(0, 90, anchor = NW, text = f"Collect {1000-discount_points} to upgrade to silver card and get all rides 10% off.", fill='grey', font=('Inter 12 bold'))
    ...
    card.update()
    card.create_text(330, 260, anchor = NW, text=f"{discount_points}/100", fill='#101828', font=('Inter 12 bold'))
